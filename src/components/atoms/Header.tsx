...
const Header = () => {
  ...
  return (
    <header className="header">
      ...
      <input className={`menu-btn ${isMenuOpenClass}`} type="checkbox" id="menu-btn"/>
      <label className={`menu-icon ${isMenuOpenClass}`}><span className="navicon" onClick={() => setIsToggle(!isToggle)}></span></label>
